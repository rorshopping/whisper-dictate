...
git clone --depth 1 --branch v1.0.3 https://github.com/rorshopping/whisper-dictate.git whisperdictate-rel 2>&1 | tail -1
...
# --- archive --------------------------------------------------------------------
ditto -c -k --sequesterRsrc --keepParent "$APP" ~/target/WhisperDictate-v1.0.3-macos-arm64-notarized.zip || FAIL "zip"
shasum -a 256 ~/target/WhisperDictate-v1.0.3-macos-arm64-notarized.zip
echo "STEP-zip-DONE"
echo "ALL-DONE"
